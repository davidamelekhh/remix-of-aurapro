...
export default function ProDashboard() {
  ...
  const statsDisplay = [
    { label: 'Projets actifs', value: stats.totalProjects.toString(), icon: Building2, color: 'text-success' },
    { label: 'Clients', value: stats.totalClients.toString(), icon: Users, color: 'text-primary' },
    { label: 'Taux de complétion', value: `${stats.avgCompletion}%`, icon: TrendingUp, color: 'text-success' },
    { label: 'En retard', value: stats.delayedProjects.toString(), icon: Clock, color: 'text-destructive' },
  ];
