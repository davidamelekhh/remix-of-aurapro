      ...
      <div className="hidden lg:block bg-background border-b border-border/20">
        <div className="max-w-[1800px] mx-auto px-12 py-4">
          <div className="grid grid-cols-[280px_1fr_320px] gap-8 items-start">
            {/* Left Navigation */}
            <div className="bg-card/50 backdrop-blur-sm border border-border/30 rounded-2xl p-4 shadow-lg flex flex-col h-[420px]">
            ...
            <motion.div
              ...
              className="bg-card/50 backdrop-blur-sm border border-border/30 rounded-2xl p-4 shadow-lg flex flex-col justify-between h-[420px]"
            >
              <div>
