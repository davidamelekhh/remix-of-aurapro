          ...
          <div className="grid grid-cols-[280px_1fr_320px] gap-12 items-start">
            ...
            <div className="flex items-center justify-center">
              <motion.div
                ...
                className="relative"
              >
                <div className="w-96 h-96 rounded-full bg-gradient-to-br from-foreground/5 to-foreground/10 border border-border/30 shadow-2xl flex items-center justify-center overflow-hidden backdrop-blur-sm">
                  {/* AI Assistant Image */}
                  <img 
                    src={aiAssistant} 
                    alt="AI Assistant" 
